...
export const swarmPractices: Record<string, PracticeDrill> = {
  ...
  'practice-assemble': {
    ...
    checks: [
      ...
      { id: 'b-slack', prompt: 'Is Slack required for this swarm?', kind: 'boolean', correctBoolean: false, explanation: 'False — this swarm uses Grok channels; Slack module is optional.' },
    ],
  },
  'practice-run-loop': {
  ...
  'practice-capstone-m7': {
    id: 'practice-capstone-m7',
    title: 'Capstone - Thursday Van Singel install swarm',
    goal: f.outcome,
    afterLesson: 'm7-practice-capstone',
